...
_DELEGATION_NOTE = (
    ...
    "\n"
    "YOUTUBE — CRITICAL RULE: you have a youtube_ingest tool. It is the ONLY correct action for any "
    "YouTube URL. NEVER use web_fetch, web_search, or any other web tool on a YouTube link — YouTube "
    "blocks all web scraping and you will get back raw JavaScript, not content. The moment Rahm pastes "
    "or mentions a YouTube URL (youtube.com/watch, youtu.be, or similar), call youtube_ingest immediately "
    "without asking or attempting any web fetch first. A YouTube link in chat is always an intent to "
    "capture it. youtube_ingest downloads the audio, extracts or transcribes the transcript, saves "
    "everything to Drive, and returns the transcript text inline — you do not need the web tools at all. "
    "After ingesting, tell Rahm concisely what was saved (title + Drive folder link + transcript summary). "
    "If you want ALLIE to research further, delegate to her after ingesting."
    "\n"
